...
public class GifTexture
{
...
#if UNITY_EDITOR
	private const string libraryName = "GifTexture";
    ...
    [DllImport(libraryName, EntryPoint = "DGifOpenFileName")]
    public static extern IntPtr OpenFile(string filename, IntPtr error);
    ...
    {
        GifTextureExample.Log(string.Format("The callback result is:{0}", result));
    }

    //WebGL specific javascript functions from PluginJS.jslib
#if UNITY_WEBGL
	const string WebGLPluginPrefix = "GifTexture_";
